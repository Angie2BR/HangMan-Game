...
//what we want to do is to choose a random word
//then guess the letters if it is in render on the dom


const Game=(_ => {
    const letters=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'];
    const words=['apple','coffe','dog','javascript','cat'];
    let chosenWord;
    let guessingWord;
    let lives;
    let guesses;
    ...
    const showInitPage=_=>{
        ...
        <p class="hangman__instructions">Pick a letter to guess the whole word.</p>
